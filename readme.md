Adaptivate is a template switcher for WordPress themes when a site is viewed on mobile devices. You may have heard of responsive web design, adpative design creates a different view based on a device. 
